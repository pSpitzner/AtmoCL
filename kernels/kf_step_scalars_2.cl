__kernel void kf_step_scalars_2_kernel_main(__private parameters par,
                                            ...
                                            __write_only image3d_t bf_scalars_vc_b)
{
  ...
  float4 z_new, mp;
  float4 fyn[3], y_s[3];
  float4 x_c[3], x_cr[3], y_c[3], y_cr[3], z_c[3], z_cr[3];
  ...
  x_c[2]  = read_f4(pos.x , pos.y , pos.z , bs_scalars_fc_x_2);
  x_cr[2] = read_f4(pos.xr, pos.y , pos.z , bs_scalars_fc_x_2);
  y_c[2]  = read_f4(pos.x , pos.y , pos.z , bs_scalars_fc_y_2);
  y_cr[2] = read_f4(pos.x , pos.yr, pos.z , bs_scalars_fc_y_2);
  z_c[2]  = read_f4(pos.x , pos.y , pos.z , bs_scalars_fc_z_2);
  z_cr[2] = read_f4(pos.x , pos.y , pos.zr, bs_scalars_fc_z_2);
  ...
  z_new += par.g[s][2]*(y_s[2]-y_s[0])/par.dT/di*par.dtis[s];   // 2
